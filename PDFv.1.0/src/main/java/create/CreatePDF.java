 ...
 */
	...
	public CreatePDF(String name1, String name2, String name3, String name4, String[] arrayHat, String Texthat, String Textgeneral, URL Imagelink, String Namefile, BaseFont BaseFontPDF) { 
		...
		try {
			PdfWriter.getInstance(document, new FileOutputStream(Namefile)); //выходной поток дл€ создани€ PDF, а внутри создаетс€ поток записи с конкретным именем
	...
	private void addRows(PdfPTable table) {
      //установка значени€ и шрифта дл€ выводимого текста в €чейки
	    ...
	    //выше должен быть текст на русском €зыке, как его вывести можно посмотреть в справке.
	}
